...
function buildTailorPrompt({ jobTitle, company, jobDescription, githubRepos }) {
  const resume = loadDataFile('resume.md');
  const coverLetter = loadDataFile('cover-letter.md');
...
module.exports = { buildTailorPrompt, buildRefinePrompt };
